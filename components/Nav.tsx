...
export function Nav() {
  const { role, isPietro, roleLabel, signOut } = useRole();
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 py-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            type="button"
            onClick={() => signOut()}
            className="inline-flex items-center gap-1.5 rounded-md border border-border px-3 py-2 text-sm text-muted-foreground transition-colors hover:border-[var(--gold)] hover:text-foreground"
          >
